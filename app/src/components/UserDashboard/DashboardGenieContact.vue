										...
										<div class="row gx-9 gy-6">
											...
											<div  class="col-xl-12">
												...
												<div class="card card-dashed h-xl-100 flex-row flex-stack flex-wrap p-6">
													...
													<div class="d-flex flex-column py-2">
														<!--begin::Owner-->
														<div class="d-flex align-items-center fs-4 fw-bolder mb-5">{{ genie_exist_contact.email  }} 
														
														</div>
                                                        <div class="d-flex align-items-center fs-4 fw-bolder mb-5">{{ genie_exist_contact.phone  }} 
														
														</div>
                                                        <div class="d-flex align-items-center fs-4 fw-bolder mb-5">{{ genie_exist_contact.website  }} 
														
														</div>
                                                        <span class="badge badge-light-success fs-7 ms-2">{{ genie_exist_contact.address  }}</span>
											...
											<div class="card card-stretch">
												<a href="#add_new_work_exp" class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
													...
													<!--end::Svg Icon-->
													<span class="fs-4 fw-bolder">Add new skill</span>
												</a>
											</div>
										</div>
											<!--end::Col-->

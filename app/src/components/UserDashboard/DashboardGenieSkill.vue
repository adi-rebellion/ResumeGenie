          ...
          <div v-if="all_skill.length > 0" class="card mb-xl-8">
              ...
              <!--end::Toolbar-->
                        ...
                        <button
                          ...
                          @click.prevent="edit_skill(skill.id)"
                        >
  ...
  <option value="Internet"></option> -->
          ...
          <!--end::Basic info-->
		    <nav class="d-flex justify-content-between align-items-center push">
                <a class="btn btn-light-danger" @click.prevent="$router.push('genie-experience')">
                  <i class="fa fa-arrow-left opacity-50 me-1"></i>
                  <span>Prev</span>
                </a>
                <a class="btn btn-light-success" @click.prevent="$router.push('genie-project')">
                  <span>Next</span>
   ...
   if(this.genie_skill.name.length > 3)
   {
	  await API.GetGenieSkillSelect(this.genie_skill).then((result) => {
       ...
       async submitButton() {
                ...
                await API.GenieSkill(this.genie_skill)
                .then((res) => {
                    if (res.status == 200) {
...
$(document).ready(function() {
	...
	async created() {
		 await API.GetAllSkill().then((result) => {
                
      
                this.all_skill = result.data;

      ...
      <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="container-xxl" id="kt_content_container">
            ...
            <div class="row g-6 g-xl-9 mb-6 mb-xl-9">
                ...
                <!--begin::Col-->
                                            <div v-for="resume in all_resume" :key="resume.id" class="col-md-6 col-lg-4 col-xl-3">
                                                <!--begin::Card-->
                                                <div class="card h-100">
                                                    <!--begin::Card body-->
                                                    <div class="card-body d-flex justify-content-center text-center flex-column p-8">
                                                        <!--begin::Name-->
                                                        <router-link  :to="{ name: 'GenieResumeCreate', params: { resume_id: resume.id } }" href="#" class="text-gray-800 text-hover-primary d-flex flex-column">
                                                            <!--begin::Image-->
                                                            <div class="symbol symbol-60px mb-5">
                                                            <img src="https://img.icons8.com/stickers/120/000000/pdf.png"/>
                                                            </div>
                                                            <!--end::Image-->
                                                            <!--begin::Title-->
                                                        ...
                                                        <!--end::Name-->
                                                        <!--begin::Description-->
                                                        <div class="fs-7 fw-bold text-gray-400">{{resume.created_at}}</div>
                                                        <!--end::Description-->
                                                    </div>
                                                    <!--end::Card body-->
                                                </div>
											...
											<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
												...
												<form id="kt_modal_new_target_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="#">
													...
													<div class="mb-13 text-center">
														...
														<!--end::Title-->
														<!--begin::Description-->
														<div class="text-muted fw-bold fs-5">Add all your career details in the career dashboard. Each resume you create is an different view into
														 your career, skills & achievements.</div>
														<!--end::Description-->
													</div>
													<!--end::Heading-->
													<!--begin::Input group-->
													<div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
														...
														<!--end::Label-->
														<input type="text" class="form-control form-control-solid" placeholder="Lets give this view of your resume a unique name" name="target_title" v-model="new_genie_resume.name">
													...
													<div class="text-center">
														...
														<button @click.prevent="add_new_resume()" type="submit" id="kt_modal_new_target_submit" class="btn bg-rg-yellow">
															<span v-if="!showResumeSaving" class="indicator-label">Create</span>

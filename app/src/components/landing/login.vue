                ...
                <div class="w-lg-500px p-10 p-lg-15 mx-auto">
                  ...
                  >
                    ...
                    <div class="text-center mb-10">
                      ...
                      <div class="text-gray-400 fw-bold fs-4">
                        ...
                        <router-link
                          ...
                          class="text-rg-yellow fw-bolder"
                        >
                    ...
                    <div class="fv-row mb-10 fv-plugins-icon-container">
                      ...
                      <div class="d-flex flex-stack mb-2">
                        ...
                        <a
                          ...
                          class="text-rg-yellow fs-6 fw-bolder"
                          >Forgot Password ?</a
                        >
                        <!--end::Link-->
                      </div>
                    ...
                    <div class="text-center">
                      <!--begin::Submit button-->
                      <div v-if="!$store.state.auth.hasAuth">
                        <button
                          type="submit"
                          id="kt_sign_in_submit"
                          class="btn btn-lg bg-rg-yellow w-100 mb-5"
                      ...
                      <div v-if="$store.state.auth.hasAuth">
                        <button
                          type="submit"
                          id=""
                          class="btn btn-lg bg-hearecho-red w-100 mb-5"
  ...
  methods: {
    async loginUser() {
      ...
      if (loginStatus.status == "success") {
        ...
        this.$router.push("p-create-resume");
      } else {

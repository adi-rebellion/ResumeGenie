					...
					<div class="d-flex flex-center flex-column flex-column-fluid">
						...
						<div class="w-lg-500px p-10 p-lg-15 mx-auto">
							...
							<!--end::Logo-->
								...
								<span class="no-mobile-view"><br><br><br><br><br><br></span>
								<div class="text-center mb-10">
									...
									<router-link :to="{name: 'landing_register'}" class="fw-bolder" style="color: #F1A81A !important;">Create an Account</router-link></div>
									<!--end::Link-->
								</div>
								<!--begin::Heading-->
								<!--begin::Input group-->
								...
								<div class="fv-row mb-10 fv-plugins-icon-container">
									...
									<div class="d-flex flex-stack mb-2">
										...
										<!--end::Label-->
										<!--begin::Link-->
										<a href="#" class="fs-6 fw-bolder"  style="color: #F1A81A !important;">Forgot Password ?</a>
										<!--end::Link-->
									</div>
									<!--end::Wrapper-->
									<!--begin::Input-->

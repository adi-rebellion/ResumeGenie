		...
		<div class="d-flex flex-column flex-root">
            ...
            />
						...
						<div class="text-center mb-5 mb-lg-10  py-lg-20">
							...
							<h1 class="text-white lh-base fw-bolder fs-2x fs-lg-3x mb-15" style="text-transform: capitalize;">A way better resume maker
							<br>with
							<span style="background: linear-gradient(to right, #12CE5D 0%, #FFD80C 100%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;">
								<span id="kt_landing_hero_text">coz that resume is your entry-ticket to the job interview</span>
							</span></h1>
							<!--end::Title-->
							<!--begin::Action-->
							
							<router-link
                  :to="{ name: 'create_resume' }"
                  class="btn bg-rg-yellow"
                  data-kt-scroll-toggle="true"
                  data-kt-drawer-dismiss="true"
                  >Build now</router-link>
				  <br><br>
							<!--end::Action-->
			...
			<div class="mb-n10 mb-lg-n20 z-index-2">
				...
				<div class="container">
					...
					<div class="text-center mb-17">
						<!--begin::Title-->
						<h3 class="fs-2hx text-dark mb-5" id="how-it-works" data-kt-scroll-offset="{default: 100, lg: 150}">1000's of designs</h3>
					...
					<div class="tns tns-default tns-initiazlied">
						<!--begin::Slider-->
						<div class="tns-outer" id="tns1-ow"><div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide <span class="current">2</span>  of 4</div><div id="tns1-mw" class="tns-ovh"><div class="tns-inner" id="tns1-iw"><div data-tns="true" data-tns-loop="true" data-tns-swipe-angle="false" data-tns-speed="2000" data-tns-autoplay="true" data-tns-autoplay-timeout="18000" data-tns-controls="true" data-tns-nav="false" data-tns-items="1" data-tns-center="false" data-tns-dots="false" data-tns-prev-button="#kt_team_slider_prev1" data-tns-next-button="#kt_team_slider_next1" class="  tns-slider tns-carousel tns-subpixel tns-calc tns-horizontal" id="tns1" style="transition-duration: 0s; transform: translate3d(-16.6667%, 0px, 0px);"><div class="text-center px-5 pt-5 pt-lg-10 px-lg-10 tns-item tns-slide-cloned" aria-hidden="true" tabindex="-1">
								<img src="theme/dist/assets/media/product-demos/demo5.png" class="card-rounded shadow mw-100" alt="">
							</div>
							<!--begin::Item-->
							<div class="text-center px-5 pt-5 pt-lg-10 px-lg-10 tns-item tns-slide-active" id="tns1-item0">
								<img src="theme/dist/assets/media/product-demos/demo1.png" class="card-rounded shadow mw-100" alt="">
							</div>
							<!--end::Item-->
							<!--begin::Item-->
							<div class="text-center px-5 pt-5 pt-lg-10 px-lg-10 tns-item" id="tns1-item1" aria-hidden="true" tabindex="-1">
								<img src="theme/dist/assets/media/product-demos/demo2.png" class="card-rounded shadow mw-100" alt="">
							</div>
							<!--end::Item-->
							<!--begin::Item-->
							<div class="text-center px-5 pt-5 pt-lg-10 px-lg-10 tns-item" id="tns1-item2" aria-hidden="true" tabindex="-1">
								<img src="theme/dist/assets/media/product-demos/demo4.png" class="card-rounded shadow mw-100" alt="">
							</div>
							<!--end::Item-->
							<!--begin::Item-->
							...
							<div class="d-flex flex-wrap flex-center justify-content-lg-between mb-15 mx-auto w-xl-900px">
								...
								<div class="d-flex flex-column flex-center h-200px w-200px h-lg-250px w-lg-250px m-3 bgi-no-repeat bgi-position-center bgi-size-contain" style="background-image: url('assets/media/svg/misc/octagon.svg')">
									...
									<span class="svg-icon svg-icon-2tx svg-icon-white mb-3">
										<img src="https://img.icons8.com/dusk/128/000000/design.png"/>
									</span>
									<!--end::Svg Icon-->
									<!--end::Symbol-->
									<!--begin::Info-->
									<div class="mb-0">
										...
										<div class="fs-lg-2hx fs-2x fw-bolder text-white d-flex flex-center">
											<div class="min-w-70px counted" style="font-size: 30px;" data-kt-countup="true" data-kt-countup-value="700" data-kt-countup-suffix="+">1000's of designs</div>
										</div>
										<!--end::Value-->
								...
								<div class="d-flex flex-column flex-center h-200px w-200px h-lg-250px w-lg-250px m-3 bgi-no-repeat bgi-position-center bgi-size-contain" style="background-image: url('assets/media/svg/misc/octagon.svg')">
									...
									<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
									<span class="svg-icon svg-icon-2tx svg-icon-white mb-3">
									<img src="https://img.icons8.com/dusk/128/000000/pdf.png"/>
									</span>
									<!--end::Svg Icon-->
									<!--end::Symbol-->
									<!--begin::Info-->
									<div class="mb-0">
										<!--begin::Value-->
										<div class="fs-lg-2hx fs-2x fw-bolder text-white d-flex flex-center">
											<div class="min-w-70px counted" data-kt-countup="true" data-kt-countup-value="700" data-kt-countup-suffix="+" style="font-size: 30px;">Save to PDF</div>
										</div>
										<!--end::Value-->
								...
								<div class="d-flex flex-column flex-center h-200px w-200px h-lg-250px w-lg-250px m-3 bgi-no-repeat bgi-position-center bgi-size-contain" style="background-image: url('assets/media/svg/misc/octagon.svg')">
									...
									<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
									<span class="svg-icon svg-icon-2tx svg-icon-white mb-3">
										<img src="https://img.icons8.com/dusk/128/000000/link--v1.png"/>
									</span>
									<!--end::Svg Icon-->
									<!--end::Symbol-->
									<!--begin::Info-->
									<div class="mb-0">
										<!--begin::Value-->
										<div class="fs-lg-2hx fs-2x fw-bolder text-white d-flex flex-center">
											<div class="min-w-70px counted" data-kt-countup="true" data-kt-countup-value="700" data-kt-countup-suffix="+" style="font-size: 30px;">Share as a link</div>
										</div>
										<!--end::Value-->
								...
								<div class="d-flex flex-column flex-center h-200px w-200px h-lg-250px w-lg-250px m-3 bgi-no-repeat bgi-position-center bgi-size-contain" style="background-image: url('assets/media/svg/misc/octagon.svg')">
									...
									<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
									<span class="svg-icon svg-icon-2tx svg-icon-white mb-3">
										<img src="https://img.icons8.com/dusk/128/000000/crowd.png"/>
									</span>
									<!--end::Svg Icon-->
									<!--end::Symbol-->
									<!--begin::Info-->
									<div class="mb-0">
										<!--begin::Value-->
										<div class="fs-lg-2hx fs-2x fw-bolder text-white d-flex flex-center">
											<div class="min-w-70px counted" data-kt-countup="true" data-kt-countup-value="700" data-kt-countup-suffix="+" style="font-size: 30px;">Used by millions</div>
										</div>
										<!--end::Value-->
								...
								<div class="d-flex flex-column flex-center h-200px w-200px h-lg-250px w-lg-250px m-3 bgi-no-repeat bgi-position-center bgi-size-contain" style="background-image: url('assets/media/svg/misc/octagon.svg')">
									...
									<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
									<span class="svg-icon svg-icon-2tx svg-icon-white mb-3">
										<img src="https://img.icons8.com/dusk/128/000000/downloading-updates.png"/>
									</span>
									<!--end::Svg Icon-->
									<!--end::Symbol-->
									<!--begin::Info-->
									<div class="mb-0">
										<!--begin::Value-->
										<div class="fs-lg-2hx fs-2x fw-bolder text-white d-flex flex-center">
											<div class="min-w-70px counted" data-kt-countup="true" data-kt-countup-value="700" data-kt-countup-suffix="+" style="font-size: 30px;">Absolutely free!</div>
										</div>
										<!--end::Value-->
								...
								<div class="d-flex flex-column flex-center h-200px w-200px h-lg-250px w-lg-250px m-3 bgi-no-repeat bgi-position-center bgi-size-contain" style="background-image: url('assets/media/svg/misc/octagon.svg')">
									...
									<span class="svg-icon svg-icon-2tx svg-icon-white mb-3">
										<img src="https://img.icons8.com/dusk/128/000000/learning.png"/>
									</span>
									<!--end::Svg Icon-->
									<!--end::Symbol-->
									<!--begin::Info-->
									<div class="mb-0">
										<!--begin::Value-->
										<div class="fs-lg-2hx fs-2x fw-bolder text-white d-flex flex-center">
											<div class="min-w-70px counted" data-kt-countup="true" data-kt-countup-value="80" data-kt-countup-suffix="K+" style="font-size: 30px;">AI powered</div>
										</div>
										<!--end::Value-->
								...
								<!--end::Item-->
								<!--begin::Item-->
								<div class="d-flex flex-column flex-center h-200px w-200px h-lg-250px w-lg-250px  bgi-no-repeat bgi-position-center bgi-size-contain" style="background-image: url('assets/media/svg/misc/octagon.svg');margin-left:auto;margin-right:auto;">
									<!--begin::Symbol-->
									<!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm002.svg-->
									<span class="svg-icon svg-icon-2tx svg-icon-white mb-3">
										<img src="https://img.icons8.com/dusk/128/000000/cover-up.png"/>
									</span>
									<!--end::Svg Icon-->
									<!--end::Symbol-->
									<!--begin::Info-->
									<div class="mb-0">
										<!--begin::Value-->
										<div class="fs-lg-2hx fs-2x fw-bolder text-white d-flex flex-center">
											<div class="min-w-70px counted" data-kt-countup="true" data-kt-countup-value="35" data-kt-countup-suffix="M+" style="font-size: 30px;"> Show / Hide Components</div>
										</div>
										<!--end::Value-->
...
<script>
// import Typewriter from "../plugin/TypeWriter.vue";
import Typewriter from "typewriter-effect/dist/core";

export default {
  mounted() {
    new Typewriter(this.$refs.landingtype, {
   ...
   metaInfo() {
        return {
            ...
            meta: [
                { name: 'description', content: 'A place where communities and their leadership members can express themselves. Know what matters to everyone. Clear communication leads to better engagement.'},
                { property: 'og:title', content: 'Hearecho - Hear what matters to your people.'},
                { property: 'og:site_name', content: 'hearecho'},
                { property: 'og:description', content: 'A place where communities and their leadership members can express themselves. Know what matters to everyone. Clear communication leads to better engagement.'},
                { property: 'og:type', content: 'website'},
                { property: 'og:url', content: 'https://hearcho.com/'},
                { property: 'og:image', content: 'https://hearecho.com/theme/dist/assets/media/logos/hearecho.png' },
               
                { name: 'twitter:card', content: 'summary_large_image'},
                { property: 'twitter:domain', content: ''},
                { property: 'twitter:url', content: 'https://hearcho.com/'},
                { property: 'twitter:title', content: 'Hearecho - Hear what matters to your people.'},
                { property: 'twitter:description', content: 'A place where communities and their leadership members can express themselves. Know what matters to everyone. Clear communication leads to better engagement.'}, 
                { property: 'twitter:image', content: 'https://hearecho.com/theme/dist/assets/media/logos/hearecho.png' },
            ]
        }
    },
};
